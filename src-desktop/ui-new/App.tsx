...
import { startRawWatcher } from "@/lib/raw-watcher"
...
function App() {
  ...
  async function handleProjectOpened(proj: WikiProject) {
    ...
    const { loadLlmConfigFile, mergeLlmConfigs } = await import("@/lib/llm-config-file")
    const fileConfig = await loadLlmConfigFile(proj.path)
    if (fileConfig) {
